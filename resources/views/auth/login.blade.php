...
<div
	...
	<div class="flex justify-center self-center  z-10">
		<div class="p-12 bg-white mx-auto rounded-3xl w-96 border-slate-900">
			<div class="mb-7">
				<h3 class="font-semibold text-2xl text-gray-800">BIENVENIDO</h3>
			</div>
			<div class="space-y-6">
				<div class="">
					<x-text-input placeholder="Email" id="email" class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-purple-400" type="email" name="email" :value="old('email')" required autofocus />
					...
					<div class="relative" x-data="{ show: true }">
						<x-text-input placeholder="Password" id="password" class="text-sm text-black-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400"
                                type="password"
                                name="password"
				...
				<div class="mt-7 text-center text-gray-300 text-xs">
					<span>
                Copyright © 2021-2023
                <a href="https://codepen.io/uidesignhub" rel="" target="_blank" title="Codepen aji" class="text-purple-500 hover:text-purple-600 "></a></span>
				</div>
			</div>
		</div>
	</div>
